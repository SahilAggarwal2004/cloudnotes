...
export default function About() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center text-center absolute top-0 w-full">
        ...
        <div className="flex flex-col h-[calc(100vh-5.5rem)] xs:h-[calc(100vh-4rem)] sm:h-[calc(100vh-2.5rem)] justify-center w-11/12 sm:max-w-fit">
          ...
          <div className="flex flex-col items-center px-10 py-4 m-3 relative mt-24 pt-16 border border-black rounded-sm" data-aos="fade-up">
            ...
            <div className="font-semibold text-lg mt-4" data-aos="fade-up">
              Sahil Aggarwal
            </div>
            <div className="text-gray-700 mt-2" data-aos="fade-up">
              CSE, 3rd Year, MSIT
            </div>
            <div className="text-gray-700 mt-2" data-aos="fade-up">
        ...
        <footer className="w-full text-center bg-purple-600 text-white px-3 py-2 flex flex-col sm:flex-row justify-between items-center space-y-1 sm:space-y-0">
          ...
          <div className="flex space-x-4 px-2">
            <a href="https://www.linkedin.com/in/sahilaggarwal2004/" target="_blank" rel="noreferrer">
              <FaLinkedin className="scale-125 inline" title="LinkedIn" />
            </a>
            <a href="https://github.com/SahilAggarwal2004" target="_blank" rel="noreferrer">
              <FaGithub className="scale-125 inline" title="GitHub" />
            </a>
          </div>
        </footer>
      </div>
